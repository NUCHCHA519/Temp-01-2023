    ...
    public class AuthController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginInput Input, string ReturnUrl)
        {
            ...
            if(data != null){
                ...
                // ตรวจสอบ User ในระบบ APIHR
                HttpClient client = new HttpClient();
                try
                {
                    var values = new Dictionary<string, string>
                            {
                                { "command","SELECT * FROM ADMIN.V_EMP_DATA_ALL_CPT where EMP_NO = '"+data.id+"'"}
                            };
                        ...
                        if(userhr == null){
                            ...
                            TempData["error"] = "EmpNo. NotActive!";
                            return View(Input);
                        }
                ...
                {                
                    TempData["error"] = $"Login Error {err.Message}!";
                    return View(Input);
                }
