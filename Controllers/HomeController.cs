    ...
    public class HomeController : Controller
    {
        ...
        public IActionResult GetUserIMG(string id="")
        {
            ...
            try {
                ...
                string URL = $"http://cis.canon-pt.co.th/cis/wwwroot/emp_pic/{id}.JPG";
                // Byte[] b = wc.DownloadData(URL);
                Image myimg = Helper.ScaleImage(Bitmap.FromStream(wc.OpenRead(URL)),300,300);
