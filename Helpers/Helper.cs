...
namespace MasterCoreMVC.Helpers
{
    ...
    {
        public static string UserImg(string baseurl,string user_id="", bool IsResize = true)
        {
            if(string.IsNullOrEmpty(user_id)){
                return $"{baseurl}/images/avatar.png";
            }            
            try {

                if(IsResize){
                    return $"{baseurl}/UserImg/{user_id}";
                }
                
                System.Net.WebClient wc = new System.Net.WebClient();
                string URL = $"http://cis.canon-pt.co.th/cis/wwwroot/emp_pic/{user_id}.JPG";
