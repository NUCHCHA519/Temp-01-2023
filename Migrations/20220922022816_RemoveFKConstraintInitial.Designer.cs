...
namespace MasterCoreMVC.Migrations
{
    ...
    [Migration("20220922022816_RemoveFKConstraintInitial")]
    partial class RemoveFKConstraintInitial
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MasterCoreMVC.Models.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            id = "016623",
                            create_by = "016623",
                            create_date = new DateTime(2022, 9, 22, 9, 28, 16, 300, DateTimeKind.Local).AddTicks(8394),
                            dept = "ICD",
                            div = "CPD",
                            ...
                            status = "active",
                            update_by = "016623",
                            update_date = new DateTime(2022, 9, 22, 9, 28, 16, 300, DateTimeKind.Local).AddTicks(8394)
                        });
                });

            modelBuilder.Entity("MasterCoreMVC.Models.tbbasic_crud", b =>
                {
                    b.Property<string>("id")
                        .HasMaxLength(36)
            ...
            modelBuilder.Entity("MasterCoreMVC.Models.tblookup", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MasterCoreMVC.Models.tbstudent", b =>
                {
                    b.Property<string>("id")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");
            ...
            modelBuilder.Entity("MasterCoreMVC.Models.LookupBasicCRUDCategory", b =>
                {
                    b.HasBaseType("MasterCoreMVC.Models.tblookup");
            ...
            modelBuilder.Entity("MasterCoreMVC.Models.LookupStudentCategory", b =>
                {
                    b.HasBaseType("MasterCoreMVC.Models.tblookup");
            ...
            modelBuilder.Entity("MasterCoreMVC.Models.tbbasic_crud", b =>
                {
                    b.HasOne("MasterCoreMVC.Models.LookupBasicCRUDCategory", "lookup_category")
                        .WithMany()
                    ...
                    b.HasOne("MasterCoreMVC.Models.AppUser", "create")
                        .WithMany()
                        .HasForeignKey("create_by");

                    b.HasOne("MasterCoreMVC.Models.AppUser", "update")
                        .WithMany()
